...
class ValueWrapperConfigurationTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return new \Fgms\BoilerPlateBundle\Configuration\MockValueWrapperConfiguration(
    ...
    {
        $config = $this->create();
        $this->expectException(\Fgms\BoilerPlateBundle\Configuration\Exception\NotLoadedException::class);
        $config->getKey();
    }
    ...
    public function testExecuteInvalidNoForm()
    {
        ...
        $this->expectException(\Fgms\BoilerPlateBundle\Configuration\Exception\InvalidExecuteException::class);
        $config->execute(null);
    }
    ...
    {
        $config = $this->create((object)['id' => 5,'key' => 'foo']);
        $form = new \Fgms\BoilerPlateBundle\Entity\Form();

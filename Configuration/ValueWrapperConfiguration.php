...
namespace Fgms\BoilerPlateBundle\Configuration;
...
abstract class ValueWrapperConfiguration extends Configuration
{
    ...
    private function update(\Fgms\BoilerPlateBundle\Entity\Form $form)
    {
        //  TODO: Implement
    ...
    private function createField(\Fgms\ValueWrapper\ValueWrapper $wrapper, \Fgms\BoilerPlateBundle\Entity\Form $form)
    {
        $retr = new \Fgms\BoilerPlateBundle\Entity\Field();
        $retr->setForm($form)
    ...
    private function createFields(\Fgms\BoilerPlateBundle\Entity\Form $form)
    {
    ...
    {
        $retr = new \Fgms\BoilerPlateBundle\Entity\Form();
    ...
    public function execute(\Fgms\BoilerPlateBundle\Entity\Form $form = null)
    {
        $this->check();

...
namespace Fgms\BoilerPlateBundle\Controller;
...
class InstallController extends BaseController
{
    ...
    public function installAction(\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        $return_url = $router->generate('fgms_boilerplate_auth',[],\Symfony\Component\Routing\Generator\UrlGeneratorInterface::ABSOLUTE_URL);
        $install_url = sprintf(
    ...
    public function authAction(\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        $store = new \Fgms\BoilerPlateBundle\Entity\Store();
        $store->setName($name);
        ...
        $em->persist($store);
        $em->flush();
        return $this->redirectToRoute('fgms_boilerplate_homepage');
    }
}

...
abstract class BaseController extends \Symfony\Bundle\FrameworkBundle\Controller\Controller
{
    ...
    {
        return $this->container->getParameter('fgms_boilerplate.config');
    }
    ...
    protected function getShopify(\Fgms\BoilerPlateBundle\Entity\Store $store)
    {
    ...
    {
        $doctrine = $this->getDoctrine();
        return $doctrine->getRepository(\Fgms\BoilerPlateBundle\Entity\Store::class);
    }
